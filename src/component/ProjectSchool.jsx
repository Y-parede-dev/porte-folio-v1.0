    ...
    return (
        <div className="page-projects-etude">
            ...
            <div className='projet-etude content-all-projects content-all-projects-3'>
                    ...
                    <a className='lien-projet'  href="https://github.com/Y-parede-dev/OC-Projet-2" target='_blank'>
                        <div className="content-project">
                            <div className="projet">
                                ...
                                <img  className='img-projets need-box-shadow' alt="Image du projet html5 css3" src={html5}/>
                ...
                <div className="projet-etude">
                     <a className='lien-projet'  href="https://github.com/Y-parede-dev/OC-Projet-3" target='_blank'>
                        <div className="content-project">
                            <div className="projet">
                                <header  className='header-projet'>
                                    <h3 >Site web animé</h3>
                                </header>
                                <img  className='img-projets need-box-shadow' alt="Image du projet animation avec css 3" src={p3}/>
                ...
                <div className="projet-etude">
                     <a className='lien-projet'  href="https://github.com/Y-parede-dev/OC-Projet-4/" target='_blank'>
                        <div className="content-project">
                            <div className="projet">
                                <header  className='header-projet'>
                                    <h3 >Référencement & SEO</h3>
                                </header>
                                <img  className='img-projets need-box-shadow' alt="Image du projet SEO & Referencement" src={p4}/>
                ...
                <div className="projet-etude">
                     <a className='lien-projet'  href="https://github.com/Y-parede-dev/P5_Construisez-un-site-e-comerce" target='_blank'>
                        <div className="content-project">
                            <div className="projet">
                                <header  className='header-projet'>
                                    ...
                                    <img  className='img-projets need-box-shadow' alt="Image du projet création site e-comerce" src={p5}/>
                ...
                <div className="projet-etude">
                     <a className='lien-projet'  href="https://github.com/Y-parede-dev/OC-p6-construisez-une-api-s-cu" target='_blank'>
                        <div className="content-project">
                            <div className="projet">
                                <header  className='header-projet'>
                                    ...
                                    <img  className='img-projets need-box-shadow' alt="Image du projet construire une api sécuriser" src={p6}/>
                ...
                <div className="projet-etude">
                     <a className='lien-projet'  href="https://github.com/Y-parede-dev/OC-p7-reseaux" target='_blank'>
                        <div className="content-project">
                            <div className="projet">
                                <header  className='header-projet'>
